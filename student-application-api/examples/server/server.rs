//! Main library entry point for hvcg_academics_openapi_student implementation.
...
pub async fn create(addr: &str, https: bool) {
    ...
    let mut service =
        hvcg_academics_openapi_student::server::context::MakeAddContext::<_, EmptyContext>::new(
            service
        );
...
use hvcg_academics_openapi_student::{
    Api,
    AddStudentResponse,
...
use hvcg_academics_openapi_student::server::MakeService;
use std::error::Error;
